...
https://sanyamaks.github.io/avito-sx-frontend-trainee-assignment/
...
- Установить зависимости при помощи npm - `yarn install`
- Запустить в development режиме - `yarn start`
- Запустить сборку production-build - `yarn build`
- Разместить production-build на github pages - `yarn deploy deploy`
